...
#
# Generated by export_simulation on Wed Dec 29 00:13:38 +0800 2021
#
################################################################################
...
switch to the './my_clk_wiz_1.sh' script.

./my_clk_wiz_1.sh -reset_run
...
./my_clk_wiz_1.sh -noclean_files

For more information on the script, please type './my_clk_wiz_1.sh -help'.
